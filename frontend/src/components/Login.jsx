...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://notenest-gyhsb4anfygqaygu.centralindia-01.azurewebsites.net/api/auth/login', {
        method: 'POST',
        headers: {
        ...
        <div className="card-interactive p-8">
          ...
          <div className="mt-8">
            <div className="flex flex-col gap-4">
              <button
                type="button"
                onClick={() => window.location.href = 'https://notenest-gyhsb4anfygqaygu.centralindia-01.azurewebsites.net/api/auth/google-login'}
